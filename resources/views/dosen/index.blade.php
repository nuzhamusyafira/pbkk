...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<div class=row>
			<div class="col-md-6">
				<a href="/dosen/create" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah</a>
			</div>
		...
		<div class="table-responsive">
			<table class="table table-bordered table-striped table-hover table-condensed tfix">
				...
				<tr>
					...
					<td align="center" width="30px">
						{!! Form::open(array('route' => array('dosen.destroy', $m->nip),'method' => 'delete','style' => 'display:inline')) !!}
